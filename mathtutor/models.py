...
class Constants:
    ...
    start_date = {
        ...
        '000': timezone.make_aware(datetime.datetime(2016, 12, 5, 16, 00), timezone.get_current_timezone()),
        ...
        '152cm2': timezone.make_aware(datetime.datetime(2017, 1, 22, 16, 00), timezone.get_current_timezone()),
